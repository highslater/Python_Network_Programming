...
tn.write(b"username S3ccna privilege 15 password S3cisco\n")
...
tn.write(b"spanning-tree vlan 1 root secondary\n")
...
tn.write(b"description PRODUCTION  TRUNK TO SW_2\n")
...
tn.write(b"description Trunk PORT TO SW_5\n")
tn.write(b"no shutdown\n")

tn.write(b"interface e1/0\n")
tn.write(b"description Trunk PORT TO SW_4\n")
tn.write(b"no shutdown\n")

tn.write(b"interface e1/1\n")
tn.write(b"description Trunk PORT TO SW_6\n")
tn.write(b"no shutdown\n")

#####Shutdown ALL Unused Ports

tn.write(b"interface range e1/1 - 3, e2/0 - 3, e3/0 - 3\n")

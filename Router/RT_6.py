...
tn.write(b"conf t\n")
tn.write(b"hostname RT_6\n")
tn.write(b"interface loopback1\n")
tn.write(b"ip address 1.1.1.6 255.255.255.255\n")
tn.write(b"interface loopback2\n")
tn.write(b"ip address 2.2.2.6 255.255.255.255\n")
tn.write(b"interface loopback3\n")
tn.write(b"ip address 3.3.3.6 255.255.255.255\n")
tn.write(b"interface loopback4\n")
tn.write(b"ip address 4.4.4.6 255.255.255.255\n")
tn.write(b"interface loopback5\n")
tn.write(b"ip address 5.5.5.6 255.255.255.255\n")
tn.write(b"exit\n")

...
tn.write(b"ip address 2.2.2.1 255.255.255.255\n")
tn.write(b"interface loopback3\n")
tn.write(b"ip address 3.3.3.1 255.255.255.255\n")
tn.write(b"interface loopback4\n")
tn.write(b"ip address 4.4.4.1 255.255.255.255\n")
tn.write(b"interface loopback5\n")
tn.write(b"ip address 5.5.5.1 255.255.255.255\n")
tn.write(b"exit\n")

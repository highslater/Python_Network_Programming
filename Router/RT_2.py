...
tn.write(b"ip address 3.3.3.2 255.255.255.255\n")
tn.write(b"interface loopback4\n")
tn.write(b"ip address 4.4.4.2 255.255.255.255\n")
tn.write(b"interface loopback5\n")
tn.write(b"ip address 5.5.5.2 255.255.255.255\n")
tn.write(b"exit\n")
